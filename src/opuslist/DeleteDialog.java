...
public class DeleteDialog extends javax.swing.JDialog {
    private JComboBox<Obra> cmbObras;
    ...
    public DeleteDialog(java.awt.Frame parent, boolean modal) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cmbObras, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        DefaultComboBoxModel<Obra> comboBoxModel = new DefaultComboBoxModel<Obra>();
        
        for(Obra u: mainForm.obras) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        for (Obra o: mainForm.obras)
            if (o.toString().equals(cmbObras.getSelectedItem()))
                mainForm.obras.remove(cmbObras.getSelectedObjects());
